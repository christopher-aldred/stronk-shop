...
export default function StrengthCalc() {
  ...
  const calcStrength = () => {
    ...
    const actAddedWeight = manualMvcEnabled
      ? mvc
      : estSingleHandMVC * 2 - weight;
        ...
        if (targetAddedWeight > 0) {
          ...
          output.push(
            <>
              <br />
              <p>
                Both your current grade and target grade require sub bodyweight
                finger strength. Focusing on technique will help you achieve
                your target, whilst strength training will help you progress
                faster.
              </p>
            </>,
          );
    ...
    output.push(
      <>
        ...
        <br />
        <p style={{ color: "grey" }}>
          ⓘ Results are based on a 20mm edge and 5s hang time
        </p>
        <br />
        <br />
      </>,
  ...
  const onMvcChange: InputNumberProps["onChange"] = (value) => {
    setMvc(parseInt(value!.toString()));
  };
          ...
          <Row>
            <Col>
              ...
              <Select
                ...
                options={
                  gradeSystem === "Boulder" ? optionsBoulder : optionsSport
                }
                value={currentGrade}
              />
            </Col>
          ...
          <Row>
            ...
            <Col>
              {trainingSystem === "Hangboard" ? (
                <>
                  <h4>
                    <Tooltip title="Weight added on a 20mm edge">
                      Max hang{" "}
                    </Tooltip>
                    <Checkbox
                      onClick={toggleMVC}
                ...
                <>
                  <h4>
                    <Tooltip title="Heaviest lift using a 20mm edge">
                      Max lift{" "}
                    </Tooltip>
                    <Checkbox
                      onClick={toggleMVC}
